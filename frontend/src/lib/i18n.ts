...
const MESSAGES = {
  fa: {
    ...
    "ui.time.modeNeedsSpan": "حالت تطبیق برای بازهٔ زمانی فعال می‌شود.",
    ...
    "ui.time.bucketLabel": "از {from} تا {to}: {count} مورد",
    "ui.time.from": "از",
    "ui.time.to": "تا",
    "ui.time.periods": "دوره‌های تاریخی",
    "ui.time.distribution": "توزیع داده‌ها در زمان",
    "ui.time.zoomIn": "بزرگ‌نمایی زمان",
    "ui.time.zoomOut": "کوچک‌نمایی زمان",
  ...
  en: {
    ...
    "ui.time.modeNeedsSpan": "Matching modes apply to a time span.",
    ...
    "ui.time.bucketLabel": "{from} to {to}: {count} items",
    "ui.time.from": "From",
    "ui.time.to": "To",
    "ui.time.periods": "Historical periods",
    "ui.time.distribution": "Data distribution over time",
    "ui.time.zoomIn": "Zoom in on time",
    "ui.time.zoomOut": "Zoom out on time",
