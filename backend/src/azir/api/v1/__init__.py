...
from . import atlas, auth, catalog, editorial, meta, tiles
...
# Tiles: a rendered-on-demand endpoint plus the built PMTiles archive (ADR-0018). Read-only and
# public, like the rest of the published corpus.
api_v1.include_router(tiles.router)
